...
4. To create a new user, set Create from existing user to **No**. Click **OK**. For step-by-step instructions, refer to section Creating a User from an Existing User
