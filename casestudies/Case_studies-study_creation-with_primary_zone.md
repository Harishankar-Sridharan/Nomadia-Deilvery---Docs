...
1. Select the **Manage Users** page. ![Frame at 1:59](../.gitbook/assets/01_StudyCreationWithPrimaryZone_timestamp_1_to_59.png)
2. Edit the specific user and click the **Roles and Rights** tab. ![Frame at 2:16](../.gitbook/assets/01_StudyCreationWithPrimaryZone_timestamp_2_to_16.png)
3. Enable rights for **Create and update zones** and **List of zones**.
4. Click the **Save** button to apply permissions. ![Frame at 3:00](../.gitbook/assets/Case-Studies-Study-creation-with-Primary-Zone_timestamp_3_to_00.png)
...
* **Study Management Page**: Your central hub for creating and editing studies and zones. ![Frame at 3:21](../.gitbook/assets/01_StudyCreationWithPrimaryZone_timestamp_3_to_21.png)
...
2. Click the **Actions** menu in the top right. ![Frame at 3:29](../.gitbook/assets/01_StudyCreationWithPrimaryZone_timestamp_3_to_29.png)
...
9. Click the **Save** button. ![Frame at 5:00](../.gitbook/assets/01_StudyCreationWithPrimaryZone_timestamp_5_to_00.png)

#### How To: Create a Primary Zone

1. Open the **Zone** tab within your new study. ![Frame at 5:31](../.gitbook/assets/01_StudyCreationWithPrimaryZone_timestamp_5_to_31.png)
...
6. Select **Primary Zone** in the **Assignment Mode** field. ![Frame at 6:26](../.gitbook/assets/01_StudyCreationWithPrimaryZone_timestamp_6_to_26.png)
...
8. Click the **Save** button. ![Frame at 7:13](../.gitbook/assets/01_StudyCreationWithPrimaryZone_timestamp_7_to_13.png)
