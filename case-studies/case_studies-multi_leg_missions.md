...
* **Agency**: Displays the current location of the mission and determines user visibility. ![Frame at 1:43](../.gitbook/assets/Case-Studies-Multi_Leg_Missions_timestamp_1_to_43.png)
...
* **Leg**: Indicates the current phase: Collection, Distribution, or Delivery. ![Frame at 2:20](../.gitbook/assets/Case-Studies-Multi_Leg_Missions_timestamp_2_to_20.png)
