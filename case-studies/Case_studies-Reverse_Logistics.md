# Case_studies-Reverse_Logistics
# Case-Studies
...
![Frame at 3:52](../images/Case-Studies-Reverse_Logistics_timestamp_3_to_52.png "Mission Identifier – The return mission ID shows the original ID with an _r suffix for easy tracking.")

* **Back to Sender**: A parameter determining if an item travels to the sender or stays at the agency.
* **New Mission Type**: A setting labeling the return as a **Cross Docking** or **Pickup** mission.
* **Edit Button**: This opens mission details to verify that pickup and delivery addresses have swapped correctly.

![Frame at 4:11](../images/Case-Studies-Reverse_Logistics_timestamp_4_to_11.png "Edit Button – Clicking this button allows you to view the swapped address details.")

### How To: Create a Cross Docking Return
Use this task when the item must return to the original sender via the agency.

1. Copy the **Mission Identifier** from the original mission in the **Back Office**.

![Frame at 2:35](../images/Case-Studies-Reverse_Logistics_timestamp_2_to_35.png "Mission Identifier – Copying the identifier from a failed delivery to trigger a return.")

2. Paste the ID into the **Mission IDs** array in the API tool.
3. Set the **Back to Sender** parameter to **True**.
4. Set the **New Mission Type** to **Cross Docking**.
5. Select **Execute** to generate the return mission.

![Flow 3:35 to 3:38](../images/Case-Studies-Reverse_Logistics_timestamp_3_to_35_to_3_to_38.gif "Execute – The API runs to create the new mission in the background.")
...
1. Copy the **Mission Identifier** for the failed delivery mission.
2. Paste the ID into the API tool.
3. Set the **Back to Sender** parameter to **False**.
4. Set the **New Mission Type** to **Pickup**.
5. Select **Execute** to create the mission.
6. Include the new **Pickup** mission in your next planning cycle for optimization.
