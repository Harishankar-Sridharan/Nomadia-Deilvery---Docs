...
This guide will walk you through organizing your delivery territories using **Studies** and **Primary Zones**. By following these steps, you can ensure your logistics operations are always ready for peak seasons and changing demands.
...
**Why use this?**
Instead of having a static map that doesn't account for busy seasons, you can switch between studies to match your actual field reality, reducing errors and ensuring orders land in the right areas.

---

### 2. Getting Started: Setting Your Access
...
![Frame at 3:29](../../images/01_StudyCreationWithPrimaryZone_timestamp_3_to_29.png "Actions menu – Top right of the page**")
...
### 4. Adding a Primary Zone to Your Study
...
![GIF at 7:13–7:23](../../images/01_StudyCreationWithPrimaryZone_timestamp_7_to_13–7_to_23.gif "Click Save – Primary zone appears as a polygon on the map**. The platform automatically draws the map boundaries based on the postal codes you entered.")
...
Imagine you have a "Standard Plan" for most of the year. However, from September to December, your order volume triples. You can create a **"Holiday Study"** with different zone boundaries and activate it specifically for those months. Once January hits, the system can automatically revert to your standard coverage.
