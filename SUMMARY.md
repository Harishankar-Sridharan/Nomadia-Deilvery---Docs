...
* [Booking Portal](11-9-appointment-booking-portal/README.md)
  * [Booking slots](11-9-appointment-booking-portal/booking-slots/README.md)
...
* [Manage Container Types](manage-container-types/README.md)
  * [Group existing missions in one container](manage-container-types/group-existing-missions-in-one-container/README.md)
    * [Container child missions](manage-container-types/group-existing-missions-in-one-container/container-child-missions/README.md)
      * [Page 1](manage-container-types/group-existing-missions-in-one-container/container-child-missions/page-1.md)
...
* [Case Studies](case-studies/README.md)
  * [Study Creation with Primary Zone](case-studies/study-creation-with-primary-zone.md)
  * [Subsector using postal code](case-studies/sub-sector-using-postal-code.md)
  * [Sub sectorize primary zone](case-studies/subsectorize-primary-zone/README.md)
    * [Dividing Sub Zones](case-studies/subsectorize-primary-zone/dividing-sub-zones.md)
    * [Merging Sub Zones](case-studies/subsectorize-primary-zone/merging-sub-zones.md)
  * [Assigning Sub Zones](case-studies/assigning-sub-zones.md)
  * [Assigning zones to missions](case-studies/assigning-zones-to-missions.md)
  * [Optimizing missions for Agency](case-studies/optimizing-missions-for-agency.md)
  * [Reduced fixed duration](case-studies/reduced-fixed-duration.md)
  * [Route Blocking Settings](case-studies/route-blocking-settings.md)
  * [Creating Backup Zone](case-studies/creating-backup-zone.md)
  * [Subcontractor Swap to Backup Zone](case-studies/subcontractor-swap-to-backup-zone.md)
  * [Subcontractor Swap to Primary Zone](case-studies/subcontractor-swap-to-primary-zone.md)
  * [Pudo configuration](case-studies/pudo-configuration/README.md)
    * [Delivery at PUDO](case-studies/pudo-configuration/delivery-at-pudo.md)
  * [Multi Leg Missions](case-studies/multi-leg-missions.md)
  * [Reassign Zones Manually](case-studies/reassign-zones-manually.md)
  * [Reverse Logistics](case-studies/reverse-logistics.md)
  * [No Route Mode](case-studies/no-route/README.md)
    * [Customizing Workflow](case-studies/no-route/customize-work-flow.md)
    * [Manage the Depots / Buildings](case-studies/no-route/manage-the-depots.md)
    * [Shuttle Management](case-studies/no-route/shuttle-management.md)
