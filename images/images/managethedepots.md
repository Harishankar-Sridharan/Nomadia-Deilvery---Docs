...
![](../../.gitbook/assets/managethedepots-managethedepots_timestamp_0_to_10_to_0_to_18.gif)

2. Click on a specific **User**.
3. Select **Roles and Rights**.
4. Enable the **Manage the Depots** option.

![](../../.gitbook/assets/managethedepots-managethedepots_timestamp_0_to_25.png)

5. Click the **Left Arrow** to return to the main menu.

![](../../.gitbook/assets/managethedepots-managethedepots_timestamp_0_to_27_to_0_to_35.gif)
